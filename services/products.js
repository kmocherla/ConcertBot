...
var celebrities = ['Celine Dion', 'Britney Spears', 'Jennifer Lopez'];
var celebrityCodes = ['C_Dion', 'B_Spears', 'J_Lopez'];

var allCategories = _.times(3)
    .map(function (i) {
        return {
            name: celebrities[i],
            imageUrl: 'https://placeholdit.imgix.net/~text?txtsize=48&txt=' + celebrityCodes[i] + '&w=640&h=330'
        };
    });
